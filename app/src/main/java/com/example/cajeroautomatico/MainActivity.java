...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean ConsultaUsuario(View view) {
        ...
        String CONDICION = String.format("Usuario = "+userName.getText().toString()+" and Password = "+passwordUser.getText().toString());
        Cursor fila = sqLiteDatabase.rawQuery("select * from Usuario where Usuario = '"+userName.getText().toString()+"' and Password = '"+passwordUser.getText().toString()+"' limit 1", null);
